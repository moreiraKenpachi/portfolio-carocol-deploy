            ...
            <div className=" flex flex-col">
                <div>
                    ...
                    <div className=" mt-3 text-center">
                        ...
                        <a className=" icon-link  hover:bg-blue-500 hover:text-white hover:no-underline" href="#" title="linkedin"><FaLinkedin/></a>
                        <a className=" icon-link  hover:bg-blue-500 hover:text-white hover:no-underline" href="#" title="github"><FaGithub/></a>
                    </div>
                </div>
